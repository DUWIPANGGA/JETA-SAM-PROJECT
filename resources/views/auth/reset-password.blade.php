...
@section('main')
    <div class="flex items-center justify-center min-h-[calc(100vh-4rem)] w-full pt-10 pb-20">
        <div class="bg-white border border-gray-200 px-8 py-10 w-[420px] shadow-sm">
            ...
            <form action="#" method="POST">
                ...
                <div class="flex justify-start">
                    <button type="submit"
                        class="bg-[#2579F6] hover:bg-blue-600 text-white rounded-full px-6 py-2.5 text-sm font-medium flex items-center justify-center shadow-[0px_4px_10px_rgba(31,40,50,0.2),inset_0px_-2px_2px_rgba(83,83,83,0.4),inset_0px_2px_2px_rgba(255,255,255,0.5)] transition-all">
                        Konfirmasi 
