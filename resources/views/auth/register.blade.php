            ...
            <form action="#" method="POST" class="mt-2">
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" placeholder="Nama anda"
                        class="w-full border border-gray-500 text-gray-800 rounded-full px-5 py-2.5 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm placeholder-gray-300">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input type="text" id="address" name="address" placeholder="Tulis alamat lengkap anda"
                            class="w-full border border-gray-500 text-gray-800 rounded-full pl-5 pr-12 py-2.5 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm placeholder-gray-300">
