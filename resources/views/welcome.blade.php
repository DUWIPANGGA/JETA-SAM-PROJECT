...
@section('main')
    ...
    <div class="min-h-[90vh] flex items-center justify-center relative overflow-hidden pt-10 pb-20">
        <div class="hidden md:block absolute left-[-50px] lg:left-[5%] top-1/2 -translate-y-1/2 z-10">
            <img src="{{ asset('images/shirt_1.svg') }}" alt="Gambar Baju" class="w-[250px] lg:w-[350px]">
        </div>
        ...
        <div class="hidden md:block absolute right-[-50px] lg:right-[5%] top-1/2 -translate-y-1/2 z-10">
            <img src="{{ asset('images/shirt_2.svg') }}" alt="Gambar Baju" class="w-[200px] lg:w-[300px]">
        </div>
    </div>
            ...
            @for ($i = 0; $i < 6; $i++)
                <div
                    ...
                    <div class="h-[240px] md:h-[280px] w-full relative overflow-hidden bg-gray-100">
                        <!-- Product Image -->
                        <img src="{{ asset('images/product_demo.jpg') }}"
    ...
    <div class="w-full h-[500px] relative overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 z-10">
            <img src="{{ asset('images/section_3_left.svg') }}" class="w-full max-w-[1000px] object-contain">
        </div>
    ...
    <div class="w-full">
        ...
        <div
            ...
            <div class="absolute left-5 bottom-0 z-10">
                <img src="{{ asset('images/person_2.svg') }}" alt="Mengapa memilih Jeta"
    ...
    <div
        ...
        <div class="w-full md:w-1/2 flex justify-center md:justify-end relative z-10">
            <img src="{{ asset('images/mobile_phone_section_4.svg') }}" alt="Testimoni"
        ...
        <div
            ...
            <img src="{{ asset('images/person_3.svg') }}" alt="Pendapat Orang"
    ...
    <div class="w-full py-20 flex flex-col items-center justify-center text-center relative overflow-hidden h-[50vh]">
        <h2
            ...
            <img src="{{ asset('images/jeta_logo_text.svg') }}" alt="Jeta Logo" class="h-10 lg:h-12 mt-2 sm:mt-0">
            <span>?</span>
        </h2>
        <button
